...
lib=loadLib()
vid_path_map= server_config['DATA_ROOT'] + "/vid_path_map"
f_vid_path_map = open(vid_path_map,"w")
for lib_entry in lib:
	s=lib[lib_entry]["filepath"]+";"+lib_entry
	f_vid_path_map.write(s+"\n")
f_vid_path_map.close()