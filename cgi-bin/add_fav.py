...
def update_lib():
	try:
		...
		f_lib.close()
		item_obj = lib_json[video_id_to_add]
		item_obj["favorite"] = "yes"
		lib_json[video_id_to_add] = item_obj
...
video_id_to_add = cgi.FieldStorage()["vid"].value
fav_list=load_list(server_config['DATA_ROOT']+"/favs.json")
fav_list.append(video_id_to_add)
